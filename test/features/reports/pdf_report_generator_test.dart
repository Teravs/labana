...
void main() {
  ...
  group('PdfReportGenerator Tests', () {
    test(
      '1. Laporan kosong menghasilkan file PDF valid dengan bytes > 0 tanpa melempar exception',
      () async {
    ...
    test(
      '3. Laporan mingguan dengan 7 hari timeline breakdown berhasil digenerate',
      () async {
    ...
    test(
      '4. Laporan bulanan dengan dataset padat (31 hari + 20 menu) berhasil merender multi-page layout',
      () async {
    ...
    test(
      '5. Nilai profit negatif tetap diformat akurat dengan tanda minus (tidak di-clamp ke 0)',
      () async {
